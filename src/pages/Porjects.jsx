...
const Porjects = () => {
    ...
    return (
        <section className="cont " id="projects">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4" data-aos='slide-up'>
                    ...
                    >
                        <div className="relative project-card h-fit rounded-lg w-fit overflow-hidden">
                            ...
                            <a href={obj.liveLink} title={obj.name} target="_blank" rel="noopener noreferrer">
                                <img className="md:blur-sm md:hover:blur-0 scale-95 hover:scale-100 duration-300" alt={obj.name} src={obj.img} />
                            </a>
